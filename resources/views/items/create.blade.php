...
<div class="row mb-4">
    <div class="col-md-10">
        <h1 class="h2"><i class="bi bi-plus-circle"></i> Add New Stock Item</h1>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('items.store') }}" method="POST" novalidate id="createForm">
                    @csrf
        ...
        <div class="card bg-light border-info">
            ...
            <div class="card-body small">
                <div class="mb-3">
                    ...
                    <p class="mb-2">A clear, descriptive product name. Must be at least 3 characters.</p>
                    <small class="text-muted">Example: Pneumatic Drill, Safety Helmet</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <p class="mb-2">Unique identifier for tracking. Cannot contain special characters except hyphens.</p>
                    <small class="text-muted">Example: PDR-001, SH-050</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <p class="mb-2">Classification for organization. Choose from: Tools, Hardware, Supplies, Equipment, Safety</p>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <p class="mb-2">Current stock count. Must be a whole number (0-999,999).</p>
                </div>
                ...
                <div class="mb-0">
                    ...
                    <p class="mb-0">Cost per unit. Must be between $0.01 and $99,999.99</p>
                </div>
            </div>
        </div>
    </div>
